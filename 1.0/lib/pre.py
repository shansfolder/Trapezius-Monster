...
class Pre(object):
    ...
    def show_info_author(self):
        ...
        '''
        h = myprint(self.screen, u"游戏内包含一些不是我原创的图片和音乐，", (50,100))
        myprint(self.screen, u"基本上出自各动漫和游戏，也有网上随便找的。", (50,105+h))
        myprint(self.screen, u"游戏内的原创部分直接编程一帧帧一个个像素点画的，", (50,110+2*h))
        myprint(self.screen, u"改了好久阿，美工无力我已经尽力了,你们马上会看到的。（笑）", (50,115+3*h))
        myprint(self.screen, u"总而言之，本游戏仅为朋友间思念（误）恶搞猪哥之用，", (50,120+4*h))
        myprint(self.screen, u"版权之类的，我什么都不知道。", (50,125+5*h))
        myprint(self.screen, u"@author: Hs", (50,130+7*h))
        '''
    ...
    def show_pretend_loading(self):
        ...
        while True:
            ...
            if Pre.counter < total_time:
                ...
                myprint(self.screen, percent_str, (215+bar_length,245), color=(255, 255, 255))
                Pre.counter += 1
            pygame.display.update()
