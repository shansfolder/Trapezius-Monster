...
class Level(object):
        ...
        if info_mode==1:
            ...
            while True:
                ...
                if self.show_info == 1:
                    ...
                    myprint(info_area, u'游戏操作：', (10, 40), color=(255,127,0))
                    myprint(info_area, u'wsad控制上下左右。', (10, 70))
                    myprint(info_area, u'你的任务是：', (10, 120), color=(255,127,0))
                    myprint(info_area, u'随着时间，斜方肌会越来越长。', (10, 150))
                    myprint(info_area, u'你要躲避斜方怪的哑铃攻击，同时', (10, 170))
                    myprint(info_area, u'不断寻找星星，防止斜方怪锻炼出', (10, 190))
                    myprint(info_area, u'自豪的斜方肌。', (10, 210))
                    myprint(info_area, u'你的可见范围只有身边一小圈。', (10, 250))
                    myprint(info_area, u'不同颜色的星星有不同作用，', (10, 270))
                    myprint(info_area, u'可以点击下方星星图标查看效果。', (10, 290))
                elif self.show_info == 3:
                ...
                myprint(item_area, u'道具宝箱', (99, 4), size='c1ss')
                ...
                if self.show_star:
                    ...
                    myprint(item_area, u'click to open', (200, 50), size='en')
    ...
    def drawitem(self, screen, itemname, item_posi, angle=-1):
        if angle == -1:
