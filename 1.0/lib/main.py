    ...
    def run(self,  mode):
        ...
        if mode==1:
            ...
            while True:
                ...
                myprint(score_area, u'LEVEL 1', (5,5), color=(255,255,255), size='enl')
                myprint(score_area, u'To Next Level: ', (5,35), color=(255,255,255), size='en')
                myprint(score_area, str(self.scoreleft), (120,35), color=(255,255,255), size='en')
                #画猪
